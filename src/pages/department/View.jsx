...
import { deleteDepartment, getDepartments } from "./Queries";
...
export const DepartmentPage = () => {
    ...
    const [selectedDepartment, setSelectedDepartment] = useState(null); //Get data for editing / deleting
    ...
    const handleDelete = async (department = null) => {
        if (!department) {
        ...
        setSelectedDepartment(null); // Reset selected department after deletion
    };
    ...
    return (
        <DepartmentsContext.Provider
            value={{ fetchDepartments, selectedDepartment, setSelectedDepartment }}
        >
            <h4 className="py-3 mb-4">
                <span className="text-muted fw-light">Setting /</span> Departments
            </h4>
            <div className="card">
                <div className="d-flex justify-content-between align-items-center card-header mb-1">
                    <h5 className="mb-0">Hospital Departments</h5>
                    <DepartmentModal
