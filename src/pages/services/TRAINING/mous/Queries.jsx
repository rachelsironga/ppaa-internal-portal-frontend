...
export const getMOUDetail = async (uid) => {
    try {
        const response = await api.get(`${API_BASE}/mous/${uid}`);
        return response.data;
    } catch (error) {
...
export const createMOU = async (mouData) => {
    try {
        const response = await api.post(`${API_BASE}/mous/create`, mouData, {
...
export const updateMOU = async (uid, mouData) => {
    try {
        const response = await api.put(`${API_BASE}/mous/${uid}/update`, mouData, {
            headers: { "Content-Type": "multipart/form-data" }
        });
        return response.data;
    } catch (error) {
...
export const deleteMOU = async (uid) => {
    try {
        const response = await api.delete(`${API_BASE}/mous/${uid}/delete`);
        return response.data;
    } catch (error) {
