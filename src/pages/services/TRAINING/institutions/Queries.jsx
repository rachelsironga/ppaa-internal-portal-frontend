...
export const getInstitutionDetail = async (uid) => {
    try {
        const response = await api.get(`${API_BASE}/institutions/${uid}`);
        return response.data;
    } catch (error) {
...
export const createInstitution = async (institutionData) => {
    try {
        const response = await api.post(`${API_BASE}/institutions`, institutionData, config);
        return response.data;
    } catch (error) {
...
export const updateInstitution = async (uid, institutionData) => {
    try {
        const response = await api.put(`${API_BASE}/institutions/${uid}`, institutionData, config);
        return response.data;
    } catch (error) {
...
export const deleteInstitution = async (uid) => {
    try {
        const response = await api.delete(`${API_BASE}/institutions/${uid}`);
        return response.data;
    } catch (error) {
...
export const getAllocationDetail = async (uid) => {
    try {
        const response = await api.get(`${API_BASE}/department-allocations/${uid}`);
        return response.data;
    } catch (error) {
...
export const createAllocation = async (allocationData) => {
    try {
        const response = await api.post(`${API_BASE}/department-allocations`, allocationData, config);
        return response.data;
    } catch (error) {
...
export const updateAllocation = async (uid, allocationData) => {
    try {
        const response = await api.put(`${API_BASE}/department-allocations/${uid}`, allocationData, config);
        return response.data;
    } catch (error) {
...
export const deleteAllocation = async (uid) => {
    try {
        const response = await api.delete(`${API_BASE}/department-allocations/${uid}`);
        return response.data;
    } catch (error) {
