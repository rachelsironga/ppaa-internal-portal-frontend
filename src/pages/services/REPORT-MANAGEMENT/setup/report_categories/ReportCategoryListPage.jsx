...
import {
  canAddReportCategory,
  canChangeReportCategory,
  canDeleteReportCategory,
...
const ReportCategoryListPage = () => {
  ...
  const addButton = canAddReportCategory(user) ? [
    {
