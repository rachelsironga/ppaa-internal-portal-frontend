  ...
  const handleQuickAction = (action) => {
    switch (action) {
      ...
      case "generate_report":
        navigate("/ppaa-internal-portal/admin/maoni/reports");
        break;
      case "settings":
                          ...
                          <tr key={category.name}>
                            ...
                            <td className="text-center">
                              <button
                                onClick={() =>
                                  navigate(
                                    `/ppaa-internal-portal/admin/maoni/category/${category.name}`
                                  )
                                }
                                className="btn btn-sm btn-outline-primary"
                              >
            ...
            <div className="col-lg-8">
              <div className="card border-0 shadow-sm h-100">
                <div className="card-header bg-white border-0 d-flex justify-content-between align-items-center">
                  ...
                  <button
                    onClick={() => navigate("/ppaa-internal-portal/admin/maoni/all")}
                    className="btn btn-sm btn-outline-primary"
                  >
                    View All
                  </button>
                            ...
                            <td>
                              <div className="btn-group">
                                <button
                                  onClick={() =>
                                    navigate(
                                      `/ppaa-internal-portal/admin/maoni/review/${contribution.id}`
                                    )
                                  }
                                  className="btn btn-sm btn-outline-primary"
                                >
                                ...
                                <button
                                  onClick={() =>
                                    navigate(
                                      `/ppaa-internal-portal/admin/maoni/${contribution.id}`
                                    )
                                  }
              ...
              <div className="card border-0 shadow-sm h-100">
                ...
                <div className="card-body">
                  <div className="d-grid gap-3">
                    ...
                    <button
                      onClick={() =>
                        navigate("/ppaa-internal-portal/admin/maoni/categories")
                      }
