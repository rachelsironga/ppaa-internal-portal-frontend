...
export const FileImportModal = ({ context }) => {
  ...
  const handleUpload = async (
    ...
    try {
      ...
      const confirmation = await Swal.fire({
        ...
        text: "Your About to Import Designations. Do you want to proceed?",
        icon: "info",
      ...
      if (confirmation.isConfirmed) {
        ...
        const result = await createUpdateData({
          url: "/api/positional-level-import",
          formData: values,
          isFullPath: true,
        });
        ...
        if (result.status === 200 || result.status === 8000) {
          ...
          setIsLoading(false);
          Swal.fire({
            title: "Process Stoped",
            html: `<div style="text-align-center">Unable to Upload Designations.<br> - <small>${result.message}</small></div>`,
            icon: "error",
          });
        }
      }
            ...
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title" id="exampleModalLabel3">
                  Import Designation From Excel Files
                </h5>
                <button
                  type="button"
                  className="btn-close"
              ...
              <Form>
                <div className="modal-body">
                  <div className="mb-3">
                    ...
                    >
                      Please upload List of Designations (Apploval levels) form
                      Excel file using the provided template format. Download
                      the template below if you do not have it. If you already
                      have a file, you may proceed with the upload.
                    </p>
                    <a
                      href="/assets/templates/system_designations.xlsx"
                      download
