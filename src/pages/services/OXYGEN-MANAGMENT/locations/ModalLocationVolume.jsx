...
const ModalLocationVolume = () => {
  ...
  const initialValues = {
    ...
    volume_uid: selectedLocationVolume?.volume_uid || "",
    quantity: selectedLocationVolume?.quantity || "",
  };
  ...
  const handleSubmit = async (
    ...
    try {
      if (selectedLocationVolume) {
        values.uid = selectedLocationVolume.uid;
      }
      const result = await createOxygenLocationVolume(values);
...
export default ModalLocationVolume;
