...
export const PeripheralAssetImportModal = ({ loadOnlyModal = false }) => {
  ...
  const handleUpload = async (values, { setSubmitting, resetForm, setErrors }) => {
    ...
    try {
      ...
      const confirmation = await Swal.fire({
        title: "Import Peripheral Assets?",
        html: `
          <p>You're about to import peripheral assets from:</p>
  ...
  const handleClose = () => {
    const modalElement = document.getElementById("peripheralAssetImportModal");
                ...
                <div className="modal-body">
                  <div className="alert alert-info mb-3">
                    ...
                    <ul className="mb-0 mt-2 small">
                      ...
                      <li>Fill in your peripheral asset data</li>
                  ...
                  <div className="mb-3">
                    <a
                      href="/assets/templates/peripheral_assets_template.xlsx"
                      download
