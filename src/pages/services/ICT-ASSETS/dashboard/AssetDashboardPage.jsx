    ...
    return (
        <>
            ...
            <div className="row">
                ...
                {/* Key Metrics Cards - Enhanced with all statuses */}
                <div className="col-lg-4 col-md-4 order-1">
                    <div className="row">
                        ...
                        {/* Other Statuses - Combined Card */}
                        <div className="col-lg-6 col-md-12 col-6 mb-4">
                            <div className="card h-100">
                                <div className="card-body">
                                    <div className="row text-center">
                                        <div className="col-4">
                                            <span className="fw-medium d-block mb-1">Retired</span>
                                            <h5 className="text-secondary mb-0">{summary?.retired_assets || 0}</h5>
                                        </div>
                                        <div className="col-4">
                                            <span className="fw-medium d-block mb-1">Lost</span>
                                            <h5 className="text-danger mb-0">{summary?.lost_assets || 0}</h5>
                                        </div>
                                        <div className="col-4">
                                            <span className="fw-medium d-block mb-1">Disposed</span>
                                            <h5 className="text-dark mb-0">{summary?.disposed_assets || 0}</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
                  ...
                  <div className="row">
                      ...
                      {/* Asset Types Breakdown - Enhanced */}
                      <div className="col-lg-4 col-md-6 mb-4">
                          <div className="card h-100">
                              <div className="card-header">
                                  <h5 className="card-title mb-0">Asset Types Overview</h5>
                              </div>
                              <div className="card-body">
                      ...
                      {/* Maintenance & Warranty Alerts - Enhanced */}
                      <div className="col-lg-4 col-md-6 mb-4">
                          <div className="card h-100">
                              <div className="card-header">
            ...
            {/* Third Row - Asset Types & Performance */}
            <div className="row">
                {/* Asset Types Breakdown - Enhanced */}
                ...
                {/* Maintenance Performance - Enhanced */}
                <div className="col-lg-6 mb-4">
                    <div className="card h-100">
                        <div className="card-header">
                            ...
                            <div className="row text-center">
                                ...
                                <div className="col-4 mb-3">
                                    <div className="border rounded p-3">
                                        ...
                                        <small className="text-muted">Scheduled Next Month</small>
                                    </div>
                                </div>
                                <div className="col-4 mb-3">
                                    <div className="border rounded p-3">
                                        ...
                                        <small className="text-muted">Avg. Days to Complete</small>
                                    </div>
                                </div>
                            </div>
                            <div className="mt-3">
                                <div className="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <span className="fw-bold text-success">
                                        ${maintenance_metrics?.maintenance_cost_ytd ? 
            ...
            {/* Fourth Row - Category Distribution & Asset Types */}
            <div className="row">
