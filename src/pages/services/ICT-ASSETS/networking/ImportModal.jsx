...
export const NetworkAssetImportModal = ({ loadOnlyModal = false }) => {
  ...
  const handleUpload = async (values, { setSubmitting, resetForm, setErrors }) => {
    ...
    try {
      ...
      const confirmation = await Swal.fire({
        title: "Import Network Assets?",
        html: `
          <p>You're about to import network assets from:</p>
  ...
  const handleClose = () => {
    const modalElement = document.getElementById("networkAssetImportModal");
                ...
                <div className="modal-body">
                  <div className="alert alert-info mb-3">
                    ...
                    <ul className="mb-0 mt-2 small">
                      ...
                      <li>Fill in your network device data</li>
                  ...
                  <div className="mb-3">
                    <a
                      href="/assets/templates/network_assets_template.xlsx"
                      download
