...
export const AssetCategoryModal = ({ loadOnlyModal = false }) => {
    ...
    const handleSubmit = async (values, { setSubmitting, resetForm, setErrors }) => {
        try {
            ...
            if (result.status === 200 || result.status === 8000) {
                showToast( `Asset Category ${selectedObj ? 'Updated' : 'Created'} Successfully`,"success","success");
                handleClose();
                resetForm();
            ...
            console.error("Asset category submission error:", error);
            showToast( "Something went wrong while saving asset category","error","error");
        } finally {
            setSubmitting(false);
        }
    };
                ...
                <div className="modal-content">
                    <div className="modal-header text-white">
                        <h5 className="modal-title">
                            ...
                            {selectedObj ? "Update Asset Category" : "Create New Asset Category"}
                        </h5>
                        <button
                            type="button"
                                    ...
                                    <div className="row text-start">
                                        <div className="col-12 mb-3">
                                            ...
                                            <Field
                                                ...
                                                placeholder="e.g., Hardware, Software, Network Equipment, Peripherals, Peripherals & Accessories "
                                            />
                                    ...
                                    <div className="row text-start">
                                        <div className="col-12 mb-3">
                                            ...
                                            <Field
                                                ...
                                                className="form-control"
                                                rows="4"
                                                placeholder="Enter a description for this asset category..."
                                            />
