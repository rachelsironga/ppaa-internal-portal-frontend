...
export const AssetTypeModal = ({ loadOnlyModal = false }) => {
    const { selectedObj, setSelectedObj, tableRefresh, setTableRefresh, handleFetchAssetType } = useContext(AssetContext);
    ...
    const handleSubmit = async (values, { setSubmitting, resetForm, setErrors }) => {
        try {
            ...
            if (result.status === 200 || result.status === 8000) {
                showToast(`Asset Type ${selectedObj ? 'Updated' : 'Created'} Successfully`, "success", "success");
                handleClose();
                resetForm();
                setTableRefresh((prev) => prev + 1);
                // Refresh the asset type data if handleFetchAssetType is available
                if (handleFetchAssetType) {
            ...
            console.error("Asset Type submission error:", error);
            showToast("Something went wrong while saving asset type", "error", "error");
        } finally {
            setSubmitting(false);
        }
    };
                ...
                <div className="modal-content">
                    <div className="modal-header text-white">
                        <h5 className="modal-title">
                            ...
                            {selectedObj ? "Update Asset Type" : "Create New Asset Type"}
                        </h5>
                        <button
                            type="button"
                                    ...
                                    <div className="row flex-row text-start justify-content-center mb-3">
                                        <div className="col-md-6 mb-3">
                                            ...
                                            <Field
                                                ...
                                                placeholder="e.g., Desktop Computer, Laptop, Printer..."
                                            />
