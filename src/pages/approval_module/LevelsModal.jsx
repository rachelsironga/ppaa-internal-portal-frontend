...
const ApprovalModuleLevelModal = () => {
    const { handleFetchData, debounceTimeout, setDebounceTimeout, selectApprovalModule, setSelectedApprovalLevelModule, selectedApprovalLevelModule } = useContext(ApprovalModuleContext)
    ...
    return (
        <>
            ...
            <div className="modal modal-slide-in" id="viewCreateDataLevelModal" tabIndex="-1" aria-hidden="true">
                <div className="modal-dialog modal-lg" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel3">{selectedApprovalLevelModule === null ? 'Add New' : 'View / Update'} Approval Module Level</h5>
                            <button
                                type="button"
                                className="btn-close"
                                onClick={handleClose}
                                    ...
                                    <div className="modal-body">
                                        ...
                                        <div className="row">
                                            <div className="col mb-3">
                                                <label htmlFor="nameLarge" className="form-label">Module</label>
                                                <Field type="text" name="module_uid" id="nameLarge" disabled={"disabled"} readonly={true} className="form-control readonly" placeholder="Enter Name" />
                                        ...
                                        <div className="row">
                                            <div className="col mb-3">
                                                <label htmlFor="levelUid" className="form-label">Level</label>
                                                <Select
                                            ...
                                            <div className="col mb-3">
                                                <label htmlFor="levelUid" className="form-label">Action</label>
                                                <Select
                                                    ...
                                                    isClearable
                                                />
                                                <Field type="hidden" name="action_uid" id="actionUidLarge" />
                                                <ErrorMessage name="action_uid" component="div" className="text-danger" />
                                            </div>
                                        </div>

                                        <div className="row">
                                            <label htmlFor="AllStatusSwitch" className="form-label">Module Level Setup</label>
                                            <div className="col mb-3">
                                                <div className="form-check form-switch">
                                                    <Field
                                                        ...
                                                        onChange={(e) => setFieldValue("is_signatory", e.target.checked)}
                                                    />
                                                    <label className="form-check-label" htmlFor="isSignatorySwitch">
                                                        Allow Level to be Signatory
                                                    </label>
                                                </div>
                                                <ErrorMessage name="is_signatory" component="div" className="text-danger" />
                                            </div>
                                            <div className="col mb-3">
                                                <div className="form-check form-switch">
                                                    <Field
