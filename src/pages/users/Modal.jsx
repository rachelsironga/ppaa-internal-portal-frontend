...
export const UserModal = ({ loadOnlyModal = false }) => {
    ...
    const validationSchema = Yup.object().shape({
        ...
        dob: Yup.date().required("Date of birth is required").typeError("Please enter a valid date of birth"),
    ...
    //for Wizard tab validation & Control
    const tabChanged = async ({ handleNext }, values, setSubmitting, resetForm, setErrors, setFieldError, setTouched, lastTab) => {
        if (isFirstTabChange) {
            ...
            >
                <div className="modal-dialog modal-lg" role="document">
                    <div className="modal-content">
                        ...
                        >
                            {({ isSubmitting, setSubmitting, values, setFieldValue, resetForm, setErrors, setFieldError, setTouched }) => (
                                <Form>
                                    <FormWizard
                                        shape="circle"
                                        color="#696cff"
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div className="row text-start">
                                                <div className="col-md-6 mb-3">
                                                    <label htmlFor="checkNumberLarge" className="form-label">
                                                        Check Number
                                                    </label>
                                                    <Field
                                                        type="text"
                                                ...
                                                <div className="col-md-6 mb-3">
                                                    <label htmlFor="AccountNumberLarge" className="form-label">
                                                        Bank Account Number
                                                    </label>
                                                    <Field
                                                        type="text"
                                        ...
                                        >
                                            ...
                                            <div className="row text-start">
                                                <div className="col-md-6 mb-3">
                                                    <label htmlFor="phoneNumberLarge" className="form-label">
                                                        Phone Number
                                                    </label>
                                                    <Field
                                                        type="text"
                                                ...
                                                <div className="col-md-6 mb-3">
                                                    <label htmlFor="AltPhoneNumberLarge" className="form-label">
                                                        Alt Phone Number
                                                    </label>
                                                    <Field
                                                        type="text"
